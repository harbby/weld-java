...
import static weld.types.PrimitiveType.Pointer;
import static weld.types.PrimitiveType.i32;
import static weld.types.PrimitiveType.i64;
import static weld.types.PrimitiveType.i8;
...
public class WeldTests {
    ...
    public void compileTestFail() {
        ...
        try {
            ...
            Assert.assertEquals(e.getMessage(), "Undefined symbol foo");
        } catch (Exception e) {
            throw e;
        }
    }
